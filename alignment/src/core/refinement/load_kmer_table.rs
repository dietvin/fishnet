...
use bstr::ByteSlice;
use kmer_table::{kmer_table::{KmerSource, KmerTable}, kmer_table_data::KmerTableData};
use noodles::sam::Header;

use crate::error::refinement_errors::load_kmer_table_errors::KmerTableLoadingError;
...
pub(crate) fn load_kmer_table(header: &Header) -> Result<KmerTable, KmerTableLoadingError> {
    ...
    log::info!("Matched kmer table {} to basecall model {}", kmer_table.source_str(), basecall_model_str);
