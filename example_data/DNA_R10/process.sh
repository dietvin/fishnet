...
# Minimal script for retrieving and processing the DNA R10 data

DORADO_BIN="/home/vincent/tools/dorado-0.9.0-linux-x64/bin/dorado"
DORADO_MODEL="/home/vincent/tools/dorado-0.9.0-linux-x64/models/dna_r10.4.1_e8.2_260bps_sup@v4.1.0"
...
wget -O "$data_archive" "ftp://ftp.sra.ebi.ac.uk/vol1/run/ERR928/ERR9287603/Ecoli_r10.4_plex.tar.gz"
tar -xzf "$data_archive" \
    -C "$fast5_directory" \
    --wildcards \
    --strip-components=6 \
    "r10.4/multiplexed_run/4Bact_NatBar_220211/20220211_1735_X1_FAS62700_5050837b/fast5_pass/barcode03/FAS62700_pass_barcode03_5c5e2a26_20.fast5"
